...
class ObeJurnalListScreen extends ConsumerWidget {
  final String courseId;

  const ObeJurnalListScreen({super.key, required this.courseId});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Jurnal Mengajar', style: AppTextStyles.heading1),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () => context.push('/obe/course/$courseId/jurnal/${eval.id}'),
