...
class ObeKinerjaListScreen extends ConsumerWidget {
  final String courseId;

  const ObeKinerjaListScreen({super.key, required this.courseId});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Kinerja Dosen', style: AppTextStyles.heading1),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () => context.push('/obe/course/$courseId/kinerja/${eval.id}'),
